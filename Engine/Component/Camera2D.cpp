...
namespace Engine
{
        ...
        m_bitmap(nullptr)
    {
        ...
        // 기본 값은 화면 해상도에 맞게
        RECT rc;
        GetClientRect(D2DRenderSystem::GetWindow()->GetHandle(), &rc);
    ...
    {
        D2DRenderSystem::GetRenderTarget()->CreateCompatibleRenderTarget(&m_bitmapRenderTarget);
    }
    ...
    void Camera2D::Render()
    {
        ...
        // 메인 렌더타겟을 받아온다.
        ID2D1HwndRenderTarget* mainRenderTarget = D2DRenderSystem::GetRenderTarget();
