...
namespace Engine
{
	FMODSound::FMODSound(const std::wstring& _key, const std::wstring& _path, ResourceType _type, bool _isLoop, int _group)
	...
	void FMODSound::Play(FMOD::Channel** _channel)
	{
		if (_channel)
